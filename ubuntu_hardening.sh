...
echo "password  requisite      pam_cracklib.so retry=3 minlen=24 difok=3 reject_username minclass=3 maxrepeat=2" >> /etc/pam.d/common-password
...
# Log the contents of /etc/passwd en /etc/shadow, and /etc/group files. OPTIONAL!
